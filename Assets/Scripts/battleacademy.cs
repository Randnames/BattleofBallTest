...
public class battleacademy : Academy
{
    ...
    public override void InitializeAcademy()
    {
        ...
        balls = new List<Ball>();
        p1.GetComponent<battleagent>().player = new Ball(Color.cyan, BallData.DefaultRadius, null, Vector3.zero, true);
        p2.GetComponent<battleagent>().player = new Ball(Color.cyan, BallData.DefaultRadius, null, Vector3.zero, true);
    ...
    public override void AcademyReset()
    {
        ...
        balls.Clear();
        balls.Add(p1.GetComponent<battleagent>().player);
        balls.Add(p2.GetComponent<battleagent>().player);
    }
